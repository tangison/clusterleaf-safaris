...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1a2420] text-white mt-auto">
      {/* Main Footer Content */}
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
          <div className="text-center md:text-left">
            ...
            {/* Tagline */}
            <p className="font-serif text-xl italic text-white/60 mb-4">
              "Africa Awaits"
            </p>
          ...
          <div className="text-center md:text-right">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-8 px-6 py-3 bg-[#0E7A3F] hover:bg-[#0B6A37] text-white text-sm font-medium rounded-full transition-all duration-200"
            >
